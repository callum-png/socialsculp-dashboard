...
const caseStudies = [
  ...
  },
  {
    ...
    title: 'Haven',
    logo: 'haven.app',
    tags: ['Lifestyle', 'Instagram', 'Creator Strategy'],
    metric: '7M',
    metricLbl: 'Views',
    campaignType: 'Creator Seeding — Lifestyle',
    description: 'Lifestyle-led creator campaign focused on Instagram Reels. Curated a network of creators aligned with brand ICP to build authentic audience trust and sustained reach.',
    highlights: [
      { label: 'Total Views', value: '7M' },
      { label: 'Platform', value: 'Instagram' },
      { label: 'Campaign Type', value: 'Brand Awareness' },
      { label: 'Creator Network', value: 'Lifestyle Niche' },
    ],
  },
  {
    num: '05',
